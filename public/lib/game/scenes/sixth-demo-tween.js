...
.defines(function(){
    ...
    ig.SixthDemoTweenScene = ig.Game.extend({
        ...
        init: function() {
            ...
            var easingFunctions = [
                ig.Tween.ease.exponentialIn,
                ig.Tween.ease.exponentialOut,
                ig.Tween.ease.exponentialInOut,
        ...
        update: function() {
            ...
            if (ig.input.pressed('action')){
                ig.scene.set(ig.SeventhDemoTweenScene);
            }
        },
        ...
        draw: function() {
            ...
            this.font.draw('6/x', x, 24, ig.Font.ALIGN.CENTER);
        }
    });
