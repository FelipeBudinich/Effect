...
.defines(function(){
    ...
    ig.NinthDemoTweenScene = ig.Game.extend({
        ...
        init: function() {
            ...
            var easingFunctions = [
                ig.Tween.ease.overshoot,
                ig.Tween.ease.drift,
                ig.Tween.ease.bounce,
        ...
        update: function() {
            ...
            if (ig.input.pressed('action')){
                ig.scene.set(ig.TenthDemoTweenScene);
            }
        },
        ...
        draw: function() {
            ...
            this.font.draw('9/x', x, 24, ig.Font.ALIGN.CENTER);
        }
    });
